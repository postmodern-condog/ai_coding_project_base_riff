...
# Note: This toolkit repo includes its own `AGENTS.md` (contributor workflow rules).
# The `AGENTS.md` generated by `/generate-plan` is written into your target project directory.
...
See `AGENTS.md` for workflow guidelines when making changes inside this toolkit repo.
...
├── AGENTS.md                        # Toolkit repo agent workflow
